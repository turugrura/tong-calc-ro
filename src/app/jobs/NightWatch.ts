  ...
  private readonly atkSkillList4th: AtkSkillModel[] = [
    {
      ...
      label: '[V3] The Vigilante at Night Lv5',
    ...
    },
    {
      ...
      label: '[V3] Hasty Fire in the Hole Lv5',
