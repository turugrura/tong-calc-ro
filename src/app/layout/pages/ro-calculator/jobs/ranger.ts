  ...
  protected _passiveSkillList: PassiveSkillModel[] = [
    BeastBaneFn(),
    {
      ...
      dropdown: [
        ...
        { label: 'Lv 1', value: 1, skillLv: 1, isUse: true, bonus: { falconDmg: 6 } },
        { label: 'Lv 2', value: 2, skillLv: 2, isUse: true, bonus: { falconDmg: 12 } },
        { label: 'Lv 3', value: 3, skillLv: 3, isUse: true, bonus: { falconDmg: 18 } },
        { label: 'Lv 4', value: 4, skillLv: 4, isUse: true, bonus: { falconDmg: 24 } },
        { label: 'Lv 5', value: 5, skillLv: 5, isUse: true, bonus: { falconDmg: 30 } },
        { label: 'Lv 6', value: 6, skillLv: 6, isUse: true, bonus: { falconDmg: 36 } },
        { label: 'Lv 7', value: 7, skillLv: 7, isUse: true, bonus: { falconDmg: 42 } },
        { label: 'Lv 8', value: 8, skillLv: 8, isUse: true, bonus: { falconDmg: 48 } },
        { label: 'Lv 9', value: 9, skillLv: 9, isUse: true, bonus: { falconDmg: 54 } },
        { label: 'Lv 10', value: 10, skillLv: 10, isUse: true, bonus: { falconDmg: 60 } },
      ],
    },
    {
      inputType: 'selectButton',
