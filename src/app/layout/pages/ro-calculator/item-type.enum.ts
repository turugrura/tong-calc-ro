export enum ItemTypeEnum {
  ...
  shadowEaring = 'shadowEaring',
  shadowEaringRefine = 'shadowEaringRefine',
  shadowEaringEnchant1 = 'shadowEaringEnchant1',
...
export const MainItemWithRelations: Partial<Record<ItemTypeEnum, ItemTypeEnum[]>> = {
  ...
  [ItemTypeEnum.shadowEaring]: [ItemTypeEnum.shadowEaringEnchant1],
